...
function StatusWaiting() {
  ...
  // declare resGetAllOrdersWaiting?.payload of orderWaitingReducer state
  const resGetAllOrdersWaiting = useSelector(
    (state) => state.orderWaitingReducer
  );
  ...
  useEffect(() => {
    setOrdersListWaiting(resGetAllOrdersWaiting?.payload);

    // console.log('««««« ordersListWaiting »»»»»', ordersListWaiting);

    setCondition((prev) => ({
      ...prev,
      total: resGetAllOrdersWaiting?.payload?.total || defaultPagination.total,
      page: resGetAllOrdersWaiting?.payload?.page || defaultPagination.page,
      pageSize:
        resGetAllOrdersWaiting?.payload?.pageSize || defaultPagination.pageSize,
    }));
    ...
    resGetAllOrdersWaiting?.payload,
  ]);
  ...
  useEffect(() => {
    const filterCustomer = () => {
      ...
      ordersListWaiting?.payload?.forEach((item, index) => {
  ...
  return resGetAllOrdersWaiting?.isLoading ? (
