  ...
  //   { path: LOCATIONS.LOGIN, name: "Login Page", element: <Login /> },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "Product List",
        element: <ProductLista />,
      },
      {
        path: LOCATIONS.PRODUCT_DETAIL,
        name: "Product Detail",
        element: <ProductDetail />,
      },
      {
        path: LOCATIONS.ADD_PRODUCT,
        name: "Product Detail",
        element: <CreateProduct />,
      },

      {
        path: LOCATIONS.UPDATE_PRODUCT,
        name: "Product Update",
        element: <UpdateProduct />,
      },

      {
        path: LOCATIONS.SEARCH_PRODUCT,
        name: "Search Product ",
